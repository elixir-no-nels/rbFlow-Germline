...
Logger.info message: "Parameters\preprocessing        \t#{options[:preprocessing]}",  logfile: wf_log
Logger.info message: "Parameters\tcalling             \t#{options[:calling]}",        logfile: wf_log
